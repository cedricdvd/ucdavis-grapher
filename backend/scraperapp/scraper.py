...
class Scraper:
    # TODO: Remove dictionaries and use database queries instead
    # Using database queries allows for more flexibility incase a crash occurs
    # and the program needs to be restarted. The current implementation
    # requires the program to be restarted from the beginning.
    ...
    def process_prerequisites(self, subject_obj, course_obj):
        ...
        prereq_arr = course_obj.prerequisites.split(';')
